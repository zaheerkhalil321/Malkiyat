...
import SheildIcon from "@src/assets/images/cnic_back.svg";
...
const CNICback = (props) => {
  ...
  async function handleSubmit() {
    const res: any = await handleDocumentsUpload();
    if (res) {
      setLoading(false);
        ...
        <View style={{ paddingHorizontal: wp(5) }}>
          ...
          >
            ...
            <ResponsiveText style={{ fontSize: 5.33 }}>
              Please upload your CNIC / NICOP
              <ResponsiveText
                style={{ fontSize: 5.33, fontFamily: Fonts.ManropeBold }}
              >
                {" "}
                back
              </ResponsiveText>{" "}
            ...
            {/* <ResponsiveText
              style={{ color: "#9E9E9E", fontSize: 3.73, marginTop: wp(1) }}
            >
              Eg: National ID / Driving License / Passport
            </ResponsiveText> */}
            <View
              style={{
                flexDirection: "row",
